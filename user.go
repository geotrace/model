...
// такого идентификатора e-mail, что избавит от головной боли с уникальностью. Или любой другой
// идентификатор, который будет действительно глобально уникальным.
//
